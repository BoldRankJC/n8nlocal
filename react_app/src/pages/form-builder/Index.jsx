...
const FormBuilder = () => {
  ...
  useEffect(() => {
    ...
    const fetchForm = async () => {
      try {
        const res = await fetch(`https://Boostedapi.vercel.app/api/forms/${formId}`);
  ...
  const saveForm = async () => {
    ...
    setIsSaving(true);
    try {
      const response = await fetch("https://Boostedapi.vercel.app/api/forms", {
        method: "POST",
  ...
  const deleteForm = async () => {
    try {
      const response = await fetch(`https://Boostedapi.vercel.app/api/forms/${formData.id}`, {
        method: "DELETE",
        headers: { "Content-Type": "application/json" },
        cache: "no-cache",
      });
  ...
  const publishForm = async () => {
    ...
    try {
      const response = await fetch(`https://Boostedapi.vercel.app/api/forms/public/${formData._id || formData.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
